...
genelist <- c(genelist$M1.Macro, genelist$M2.Macro, genelist$DC1, genelist$DC2, genelist$DC3, genelist$DC4, genelist$DC5, genelist$DC6, genelist$Langerhan)
...
DotPlot(APC, features = genes) + coord_flip() + 
    scale_color_gradientn(colors = rev(colorblind_vector(11))) + 
    guides(color = F, size = F) +
    scale_size(range = c(0.5,3.5))
ggsave(path = "DataAnalysis/CellType/APC/markers", file = "SelectMarkers_dotplot.eps", height=6, width=2.5)
```
