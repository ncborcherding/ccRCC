...
```{r}
Macro <- NormalizeData(Macro)
markers <- FindAllMarkers(Macro, logfc = 0.0, min.pct = 0, pseudocount.use = 0.1, only.pos = TRUE)

  
write.table(markers, file="./DataAnalysis/CellType/APC/Macrophage/FindAllMarkers.txt",
                sep="\t",append=F, row.names = FALSE)
```
