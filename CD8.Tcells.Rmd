...
ggsave(path = "DataAnalysis/CellType/CD8.Tcells/markers", file = "Top10_dotplot.eps", height=8, width=3)
```
...
sds <- slingshot(Embeddings(Tcells, "umap"), clusterLabels = Tcells@active.ident, allow.breaks = TRUE, stretch = 0, reducedDim = "UMAP", start.clus = 4, end.clus = 1, shrink.method = "gaussian") #Calcualting the trajectory
```
