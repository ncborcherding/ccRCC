...
```{r}
FeaturePlot(Tcells, features = "CTLA4")
DoMultiBarHeatmap(Tcells, features= c("CD69","FOS", "DUSP4", "JUNB", "XCL1"), group.by="PseudoT3", additional.group.by = c("PT1", "PT2", "PT3", "PT4", "PT5")) + scale_fill_gradientn(colors = rev(colorblind_vector(11)))
```
...
clonalProportion(df, cloneCall = "gene+nt")
