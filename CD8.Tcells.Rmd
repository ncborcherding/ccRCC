...
sc11.cells <- which(Idents(Tcells) == 11)
sc11.cells <- names(Idents(Tcells))[sc11.cells]
Idents(Tcells, cells = sc11.cells) <- 9
```
...
colnames(PT) <- c("PseudoT1", "PseudoT2", "PseudoT3", "PseudoT4")
names <- rownames(PT)
PT <- PT %>%
