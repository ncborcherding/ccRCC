...
sds <- slingshot(Embeddings(Tcells, "umap"), clusterLabels = Tcells@active.ident, allow.breaks = TRUE, stretch = 0, reducedDim = "UMAP", start.clus = 0, shrink.method = "gaussian") #Calcualting the trajectory
```
...
save(ES, file = "./DataAnalysis/CellType/CD4.Tcells/GSEA/H_enrichment.rda")
```
