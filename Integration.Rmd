...
Based on the expression pattern differences, we will subset the data from 3 clusters - cluster 8 (T Cells), cluster 9 (APCs), and cluster 14 (B cells) and then we call DietSeurat() to just isolate the RNA data so we can now perform the integration across all samples.
